...
assert.match(html, /<script src="baseball-data\.js\?v=28"><\/script>/, 'index.html must load baseball-data.js');
assert.ok(html.indexOf('baseball-data.js?v=28') < html.indexOf('app.js?v=28-consolidated-abs'), 'baseball-data.js must load before app.js');
...
assert.match(worker, /"\/baseball-data\.js\?v=28"/, 'service worker must cache the connection module');
