...
assert.match(html, /<script src="baseball-data\.js\?v=23"><\/script>/, 'index.html must load baseball-data.js');
assert.ok(html.indexOf('baseball-data.js?v=23') < html.indexOf('app.js?v=23'), 'baseball-data.js must load before app.js');
...
assert.match(worker, /"\/baseball-data\.js\?v=23"/, 'service worker must cache the connection module');
