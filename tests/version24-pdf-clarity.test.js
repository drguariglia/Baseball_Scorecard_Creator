...
ok(index.includes('Version 27'), 'interface identifies Version 24');
...
ok(app.includes('service-worker.js?v=27.2-mobile-roster-save'), 'Version 27 service worker cache identifier is used');
