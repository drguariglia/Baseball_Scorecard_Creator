...
ok(index.includes('Version 28'), 'interface identifies Version 24');
...
ok(app.includes('service-worker.js?v=28-consolidated-abs'), 'Version 28 service worker cache identifier is used');
