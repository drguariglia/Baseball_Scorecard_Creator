...
assert.match(html, /styles\.css\?v=27.2-quick-code-k-font/, 'updated stylesheet must be cache-busted');
assert.match(html, /app\.js\?v=27.2-quick-code-k-font/, 'updated JavaScript must be cache-busted');
