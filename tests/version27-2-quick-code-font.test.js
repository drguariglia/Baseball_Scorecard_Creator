...
assert(html.includes('styles.css?v=28-consolidated-abs'),'HTML must request the corrected stylesheet');
assert(html.includes('app.js?v=28-consolidated-abs'),'HTML must request the corrected app script');
assert(sw.includes('guariglia-scorecard-v28-consolidated-abs'),'service-worker cache must be refreshed');
console.log('Version 28 Quick Code font tests passed.');
