...
assert(html.includes('styles.css?v=27.2-quick-code-k-font'),'HTML must request the corrected stylesheet');
assert(html.includes('app.js?v=27.2-quick-code-k-font'),'HTML must request the corrected app script');
assert(sw.includes('guariglia-scorecard-v27-2-quick-code-k-font'),'service-worker cache must be refreshed');
