...
assert.match(html, /styles\.css\?v=24-sharp-pdf/, 'responsive stylesheet must be cache-busted');
assert.match(app, /service-worker\.js\?v=24-sharp-pdf/, 'service worker registration must be cache-busted');
