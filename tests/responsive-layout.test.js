...
assert.match(html, /styles\.css\?v=28-consolidated-abs/, 'responsive stylesheet must be cache-busted');
assert.match(app, /service-worker\.js\?v=28-consolidated-abs/, 'service worker registration must be cache-busted');
