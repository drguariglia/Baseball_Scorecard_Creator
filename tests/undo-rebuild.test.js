...
assert.match(html, /app\.js\?v=28-consolidated-abs/, 'undo-rebuild JavaScript must be cache-busted');
assert.match(worker, /guariglia-scorecard-v28-consolidated-abs/, 'service-worker cache must be bumped for the undo fix');
